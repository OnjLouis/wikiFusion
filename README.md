...
1. Download [wikiFusion.nvda-addon](https://github.com/OnjLouis/wikiFusion/releases/download/v1.5.0/wikiFusion.nvda-addon).
...
- Latest release: [v1.5.0](https://github.com/OnjLouis/wikiFusion/releases/tag/v1.5.0)
